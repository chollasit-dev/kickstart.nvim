...
--   desc = 'Save then format when exiting insert mode',
--   group = vim.api.nvim_create_augroup('at-home-save-then-format-after-typing', { clear = true }),
--   pattern = { '*' },
--   callback = function()
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.filetypes, { desc = '[S]earch File [T]ype' })
